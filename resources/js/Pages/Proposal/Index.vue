<template>
  ...
  <div class="dark:text-white">
    <Table title="Proposal" model="proposal" :actions="actions" :items="items" :headers="headers"
      :table_filters="table_filters" import_url="import-proposals" add_item_route="proposal.create" :users="users"
      :selectable="true" :bulk-actions="bulkActions" />
  </div>
</template>
<script setup>
...
const table_filters = [
  ...
  // },
  {
    name: t("complete donating status date from"),
    model: "complete_donating_status_date_from",
    type: "date"
  },
  {
    name: t("complete donating status date to"),
    model: "complete_donating_status_date_to",
    type: "date"
  },
];
const actions =
