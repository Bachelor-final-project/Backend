...
class BeneficiariesExport implements FromCollection, WithEvents, WithHeadings, WithCustomStartCell, WithStrictNullComparison, ShouldAutoSize, WithStyles
{
    ...
    public function collection()
    {
        ...
        $usersCollection = Beneficiary::search($this->request)->sort($this->request)->get()->map->only(array_column($headers, 'key'));
        // logger("Users");
