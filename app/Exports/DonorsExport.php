...
class DonorsExport implements FromCollection, WithEvents, WithHeadings, WithCustomStartCell, WithStrictNullComparison, ShouldAutoSize, WithStyles
{
    ...
    public function collection()
    {
        ...
        $usersCollection = Donor::search($this->request)->sort($this->request)->get()->map->only(array_column($headers, 'key'));
        // logger("Users");
    ...
    public static function beforeSheet(BeforeSheet $event)
    {
        ...
        $sheet = $event->sheet;
        $highestColumn = Coordinate::stringFromColumnIndex(count(Donor::headers()));
