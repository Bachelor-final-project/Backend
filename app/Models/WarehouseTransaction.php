...
class WarehouseTransaction extends BaseModel
{
    ...
    protected $appends = ['item_name', 'unit_name', 'transaction_type_str', 'warehouse_name', 'stakeholder_name', 'created_at_date_time'];
    ...
    public static function headers($user = null)
    {
        return [
            ...
            ['sortable' => true, 'value' => 'transaction_created_at', 'key' => 'created_at_date_time'],
